<template>
  ...
  >
    ...
    <div slot="content" class="m-20px">
      ...
      ><template
        v-else-if="
          isLoggedIn && userData && userData.id === id && initialValues
        "
      >
        <div class="my-20px">
          <Form
            ...
            #default="{ isSubmitting, isValid, isDisabledBtn }"
          >
            ...
            <template v-for="item in items">
              ...
              >
                <div
                  ...
                  :class="`${
                    item.name === 'password'
                      ? 'btn absolute top-0 right-0 w-full h-full text-white text-right text-sm'
                      : ''
                  }`"
                  @click="
                    () => {
            ...
            <button
              :class="`w-full btn py-15px px-20px my-20px rounded-15px border body-2 ${
                isDisabledBtn || isDemo
                  ? 'border-fade-gray text-fade-gray bg-primary'
